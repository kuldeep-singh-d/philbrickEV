...
const slice = createSlice({
  name: 'get-material-outward-detail',
  initialState: {
    loading: false,
    error: undefined,
...
export const getMaterialOutwardDetail = (id: any) =>
  apiCallBegan({
    method: methods.GET,
    onFailed: failed.type,
    onStart: requested.type,
    onSuccess: success.type,
    url: apiRoutes.materialOutwardDetail + id,
  });

export const clearMaterialOutwardDetailRes = () =>
