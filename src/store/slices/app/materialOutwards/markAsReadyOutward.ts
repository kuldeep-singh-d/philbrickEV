...
export const markAsReadyOutward = (id: any) =>
  apiCallBegan({
    method: methods.POST,
    onFailed: failed.type,
    onStart: requested.type,
    onSuccess: success.type,
    url: `${apiRoutes.markAsReadyOutward}${id}/mark-as-ready`,
  });

export const clearMarkAsReadyOutwardRes = () =>
