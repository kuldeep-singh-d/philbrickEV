...
const slice = createSlice({
  name: 'get-material-inward-detail',
  initialState: {
    loading: false,
    error: undefined,
...
export const getMaterialInwardDetail = (id: any) =>
  apiCallBegan({
    method: methods.GET,
    onFailed: failed.type,
    onStart: requested.type,
    onSuccess: success.type,
    url: apiRoutes.materialInwardDetail + id,
  });

export const clearMaterialInwardDetailRes = () =>
